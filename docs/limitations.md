...
- **Hosted releases are live** (v1.0.0 and v1.0.1, 2026-08-21, both
  published by the tag-driven workflow; each published JAR
  checksum-verified). Subsequent releases are the same tag push.
