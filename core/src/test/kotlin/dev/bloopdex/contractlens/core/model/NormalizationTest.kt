...
class NormalizationTest : StringSpec({
    ...
    "operation ordering is by path identity then method" {
        ...
        listOf(c, a, b).sortedWith(operationOrder) shouldBe listOf(b, a, c)
    }
    ...
    "canonical() re-sorts properties and required sets" {
        val node = SchemaNode(
            ...
            format = null,
            properties = mapOf(
                "b" to SchemaNode(NodeType.SCALAR, listOf("string"), null, emptyMap(), emptyList(), null, emptyList(), false, null, null, false, "p.b"),
                "a" to SchemaNode(NodeType.SCALAR, listOf("string"), null, emptyMap(), emptyList(), null, emptyList(), false, null, null, false, "p.a"),
            ),
